(function () {
  ...
  // Only the notification email (to nagendra@mpkmining.com) is sent from
  // here. The visitor no longer gets an emailed "thank you" — they see the
  // on-page thank-you popup below instead. NOTE: if a submitter is still
  // getting a mailed reply, check the "Auto-Reply" tab on this template in
  // your EmailJS dashboard and turn it off there — that setting lives on
  // EmailJS's servers, not in this file.
